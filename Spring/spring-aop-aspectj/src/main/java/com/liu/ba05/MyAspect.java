...
//    }
     ...
     *
     */
    @Around(value = "execution(* com.liu.ba05.SomeServiceImpl.doFirst(..))")
...
//        4.修改原来的目标方法的执行结果，影响最后的调用结果
     ...
     *          如果有异常，可以发送邮件，短信进行通知
     */
    @AfterThrowing(value = "execution(* com.liu.ba05.SomeServiceImpl.doSecond(..))",
            throwing = "ex")
     ...
     *  2.在目标方法之后执行的
     */
//    @After(value = "execution(* com.liu.ba05.SomeServiceImpl.doThird(..))")
    @After(value = "mypt()")
    public void myAfter(){
        System.out.println("该方法无论如何都会被执行");
    }

//    @Before(value = "execution(* com.liu.ba05.SomeServiceImpl.doThird(..))")
    @Before(value = "mypt()")
    public void myBefore(){
     ...
     */
    @Pointcut(value = "execution(* com.liu.ba05.SomeServiceImpl.doThird(..))")
    public void mypt() {
        // 无需代码
    }
