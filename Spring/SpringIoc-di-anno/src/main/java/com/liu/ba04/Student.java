...
public class Student {
    ...
    /**
     * @Resource:来自jdk的注解，实现引用类型的赋值，spring框架提供了对这个注
     * @解的功能支持，使用的也是自动注入原理，支持byName，byType，默认是byName
     * @Resource:位置： 1. 在属性定义的上面，无需set方法，推荐使用
     *                  2. 在set方法的上面
     * more是 byName，先使用byName自动注入，如果byName赋值失败，在使用byType
      */
    @Resource
    private School school;
